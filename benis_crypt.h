 ...
 * \param input The input that shall be encrypted and hidden inside img. This will assume input to be in a valid state.
 ...
 * \param output The output stream. Will be assumed to be in a valid state.
